...
#if defined(XSUM_WITH_LIBGCRYPT_BLAKE2) || defined(XSUM_WITH_LIBB2) || defined(XSUM_WITH_OPENSSL_BLAKE2) || defined(XSUM_WITH_CRYPTOPP) || defined(XSUM_WITH_CPPCRYPTO) || defined(XSUM_WITH_RHASH)
...
#if defined(XSUM_WITH_LIBGCRYPT_BLAKE2) || defined(XSUM_WITH_LIBSODIUM) || defined(XSUM_WITH_LIBB2) || defined(XSUM_WITH_BOTAN_BLAKE2B) || defined(XSUM_WITH_OPENSSL_BLAKE2) || defined(XSUM_WITH_CRYPTOPP) || defined(XSUM_WITH_CPPCRYPTO) || defined(XSUM_WITH_RHASH)
...
#if defined(XSUM_WITH_LIBGCRYPT_STREEBOG) || defined(XSUM_WITH_GNUTLS_STREEBOG) || defined(XSUM_WITH_BOTAN_STREEBOG) || defined(XSUM_WITH_OPENSSL_STREEBOG) || defined(XSUM_WITH_CPPCRYPTO) || defined(XSUM_WITH_RHASH)
